...
var deconstruction = (function( scope ){
	...
	var ratioVisual = 1,	//ratio taille du monde CANNON / taille fen�tre
		speedEngine = 1,
		sceneBox = null,
		...
		var renderAllTextures = function( dom ){
			...
			return promiseAllAsObject( promises )
                .then( o => {
                    ...
                    // document.body.appendChild(o.illu)
                    // o.illu.style.position='absolute'
                    // o.illu.style.top=0
